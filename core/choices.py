...
STATUS_CHOICES = Choices(
    (StatusChoices.DRAFT, _('MODEL_STATUS_DRAFT')),
    (StatusChoices.PENDING_REVIEW, _('MODEL_STATUS_PENDING_REVIEW')),
    (StatusChoices.UNDER_REVIEW, _('MODEL_STATUS_UNDER_REVIEW')),
    (StatusChoices.PUBLISHED, _('MODEL_STATUS_PUBLISHED')),
    (StatusChoices.UNPUBLISHED, _('MODEL_STATUS_UNPUBLISHED')),
    (StatusChoices.REJECTED, _('MODEL_STATUS_REJECTED')),
    (StatusChoices.APPROVED, _('MODEL_STATUS_APPROVED'))
    )
