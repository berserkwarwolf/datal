...
class DataStreamDBDAO(AbstractDataStreamDBDAO):
    ...
    def get(self, language, datastream_id=None, datastream_revision_id=None, guid=None, published=True):
        ...
        datastream = dict(
            ...
            last_revision_id=datastream_revision.dataset.last_revision_id if datastream_revision.dataset.last_revision_id else '',
            last_published_revision_id=datastream_revision.dataset.last_published_revision_id if datastream_revision.dataset.last_published_revision_id else '',
