...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatasetRevision.modified_at'
        db.add_column('ao_dataset_revisions', 'modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 9, 17, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'VisualizationRevision.modified_at'
        db.add_column('ao_visualizations_revisions', 'modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 9, 17, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'DataStreamRevision.modified_at'
        db.add_column('ao_datastream_revisions', 'modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 9, 17, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatasetRevision.modified_at'
        db.delete_column('ao_dataset_revisions', 'modified_at')

        # Deleting field 'VisualizationRevision.modified_at'
        db.delete_column('ao_visualizations_revisions', 'modified_at')

        # Deleting field 'DataStreamRevision.modified_at'
        db.delete_column('ao_datastream_revisions', 'modified_at')
