...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DataStreamRevision.dataset'
        db.alter_column('ao_datastream_revisions', 'dataset_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Dataset'], on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'DataStreamRevision.dataset'
        db.alter_column('ao_datastream_revisions', 'dataset_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Dataset']))
