...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SourceDatastream.datastreamrevision'
        db.alter_column('ao_sources_datastream_revision', 'datastreamrevision_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.DataStreamRevision'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SourceDatastream.datastreamrevision'
        raise RuntimeError("Cannot reverse this migration. 'SourceDatastream.datastreamrevision' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'SourceDatastream.datastreamrevision'
        db.alter_column('ao_sources_datastream_revision', 'datastreamrevision_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.DataStreamRevision']))
