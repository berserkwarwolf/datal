...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DataStream.last_revision'
        db.alter_column('ao_datastreams', 'last_revision_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['core.DataStreamRevision']))

        # Changing field 'DataStream.last_published_revision'
        db.alter_column('ao_datastreams', 'last_published_revision_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['core.DataStreamRevision']))

    def backwards(self, orm):

        # Changing field 'DataStream.last_revision'
        db.alter_column('ao_datastreams', 'last_revision_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.DataStreamRevision']))

        # Changing field 'DataStream.last_published_revision'
        db.alter_column('ao_datastreams', 'last_published_revision_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.DataStreamRevision']))
