...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DatasetRevision.impl_details'
        db.alter_column('ao_dataset_revisions', 'impl_details', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # Changing field 'DatasetRevision.impl_details'
        db.alter_column('ao_dataset_revisions', 'impl_details', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'core.datasetrevision': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'impl_details': ('django.db.models.fields.TextField', [], {}),
