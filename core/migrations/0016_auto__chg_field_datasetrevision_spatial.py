...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DatasetRevision.spatial'
        db.alter_column('ao_dataset_revisions', 'spatial', self.gf('django.db.models.fields.CharField')(max_length=80))

    def backwards(self, orm):

        # Changing field 'DatasetRevision.spatial'
        db.alter_column('ao_dataset_revisions', 'spatial', self.gf('django.db.models.fields.TextField')())
