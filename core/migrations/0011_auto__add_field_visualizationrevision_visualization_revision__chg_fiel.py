...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VisualizationRevision.visualization_revision'
        db.add_column('ao_visualizations_revisions', 'visualization_revision',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.VisualizationRevision']),
                      keep_default=False)


        # Changing field 'Visualization.last_revision'
        db.alter_column('ao_visualizations', 'last_revision_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['core.VisualizationRevision']))

        # Changing field 'Visualization.last_published_revision'
        db.alter_column('ao_visualizations', 'last_published_revision_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['core.VisualizationRevision']))

    def backwards(self, orm):
        # Deleting field 'VisualizationRevision.visualization_revision'
        db.delete_column('ao_visualizations_revisions', 'visualization_revision_id')


        # Changing field 'Visualization.last_revision'
        db.alter_column('ao_visualizations', 'last_revision_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.VisualizationRevision']))

        # Changing field 'Visualization.last_published_revision'
        db.alter_column('ao_visualizations', 'last_published_revision_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.VisualizationRevision']))
    ...
    models = {
        ...
        u'core.datastreamrevision': {
            ...
            'dataset': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Dataset']", 'on_delete': 'models.PROTECT'}),
            'datastream': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.DataStream']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meta_text': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
