...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Log.dashboard'
        db.delete_column('ao_logs', 'dashboard_id')

        # Deleting field 'ObjectGrant.dashboard'
        db.delete_column('ao_user_object_grants', 'dashboard_id')
    ...
    def backwards(self, orm):
        ...
        db.create_table('ao_dashboards', (
            ('guid', self.gf('django.db.models.fields.CharField')(max_length=29, unique=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User'], on_delete=models.PROTECT)),
        ))
        ...
        # Adding field 'Log.dashboard'
        db.add_column('ao_logs', 'dashboard',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Dashboard'], null=True, on_delete=models.DO_NOTHING),
                      keep_default=False)

        # Adding field 'ObjectGrant.dashboard'
        db.add_column('ao_user_object_grants', 'dashboard',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Dashboard'], null=True),
                      keep_default=False)
