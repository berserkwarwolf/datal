...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VisualizationRevision.datastream'
        db.add_column('ao_visualizations_revisions', 'datastream',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.DataStream']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VisualizationRevision.datastream'
        db.delete_column('ao_visualizations_revisions', 'datastream_id')
