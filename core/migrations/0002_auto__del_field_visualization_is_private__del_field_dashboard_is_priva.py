...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Visualization.is_private'
        db.delete_column('ao_visualizations', 'is_private')

        # Deleting field 'Dashboard.is_private'
        db.delete_column('ao_dashboards', 'is_private')

        # Deleting field 'DataStream.is_private'
        db.delete_column('ao_datastreams', 'is_private')


    def backwards(self, orm):
        # Adding field 'Visualization.is_private'
        db.add_column('ao_visualizations', 'is_private',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Dashboard.is_private'
        db.add_column('ao_dashboards', 'is_private',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DataStream.is_private'
        db.add_column('ao_datastreams', 'is_private',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)
