...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VisualizationRevision.lib'
        db.add_column('ao_visualizations_revisions', 'lib',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VisualizationRevision.lib'
        db.delete_column('ao_visualizations_revisions', 'lib')
