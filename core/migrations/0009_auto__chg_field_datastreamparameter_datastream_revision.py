...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DataStreamParameter.datastream_revision'
        db.alter_column('ao_datastream_parameters', 'datastream_revision_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.DataStreamRevision'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'DataStreamParameter.datastream_revision'
        raise RuntimeError("Cannot reverse this migration. 'DataStreamParameter.datastream_revision' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'DataStreamParameter.datastream_revision'
        db.alter_column('ao_datastream_parameters', 'datastream_revision_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.DataStreamRevision']))
