...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VisualizationRevision.datastream_revision'
        db.add_column('ao_visualizations_revisions', 'datastream_revision',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.DataStreamRevision']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'VisualizationRevision.datastream_revision'
        db.delete_column('ao_visualizations_revisions', 'datastream_revision_id')
