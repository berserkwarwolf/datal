                ...
                try {
                    ...
                    var time = null;
                        ...
                        case 10:
                            ...
                            break;
                        case 1:
                            /* fixed by Martin, for 2012-02-07T00:00:00 (Doctrine Entity -> Json Serializer) */
                            var values2 = values[0].split("");
                            year=values2[0]+values2[1]+values2[2]+values2[3];
                            month= values2[5]+values2[6];
                            dayOfMonth = values2[8]+values2[9];
                            time = parseTime(values2[11]+values2[12]+values2[13]+values2[14]+values2[15]+values2[16]+values2[17]+values2[18])
                            date = new Date(year, month - 1, dayOfMonth);
                            dayOfWeek = date.getDay();
                            break;
                        default:
...
jQuery(document).ready(function () {
    ...
    jQuery(".longDateFormat").each(function (idx, elem) {
        if (jQuery(elem).is(":input")) {
            ...
            jQuery(elem).text(jQuery.format.date(jQuery.trim(jQuery(elem).text()), 'MMM d, yyyy, hh:mm a'));
        }
    });
});