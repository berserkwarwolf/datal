var personalizeView = Backbone.View.extend({
	...
	events:{
		...
		'click #id_noThemeButton, #id_theme0Button, #id_theme1Button, #id_theme2Button, #id_theme3Button, #id_theme4Button, #id_theme5Button, #id_theme6Button, #id_theme8Button': 'onSwitchThemeButtonClicked',
	},
