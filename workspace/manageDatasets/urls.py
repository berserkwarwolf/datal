...
urlpatterns = patterns(
    ...
    url(r'^unpublish/(?P<type>[a-z]+)/(?P<dataset_revision_id>\d+)$', unpublish, name='manageDatasets.unpublish'),
    url(r'^unpublish/(?P<dataset_revision_id>\d+)$', unpublish, name='manageDatasets.unpublish'),
