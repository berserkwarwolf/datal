...
urlpatterns = patterns('',
    ...
    url(r'^get_last_30_days_visualization/(?P<id>\d+)$', 'core.chart_manager.views.get_last_30_days_visualization', name='chart_manager.get_last_30_days_visualizationb'),
)
